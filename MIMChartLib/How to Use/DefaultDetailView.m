...
@implementation DefaultDetailView
...
{
    return @"Default Detail View For Pie Charts (Tap on Pie to view pop Up)";
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) 
    {
        case 0:
        {
            ...
            myPieChart.detailPopUpType=mPIE_DETAIL_POPUP_TYPE1;
            //myPieChart.arrowDirection=DIRECTION_LEFT;//This is default arrow Direction for Arrows of POPUP
