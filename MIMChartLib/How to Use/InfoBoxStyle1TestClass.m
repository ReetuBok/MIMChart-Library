...
@implementation InfoBoxStyle1TestClass
...
{
    return @"Default Info Box Style 2  For Pie Charts";
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) 
    {
        case 0:
        {
            ...
            myPieChart1.detailPopUpType=mPIE_DETAIL_POPUP_TYPE1; // FIX THIS
            ...
            myPieChart1.infoBoxStyle=INFOBOX_STYLE2;
