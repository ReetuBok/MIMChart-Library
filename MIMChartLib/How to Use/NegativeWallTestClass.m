...
@implementation NegativeWallTestClass
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.contentView addSubview:[self createLabelWithText:@"coming soon."]];
    /*
    switch (indexPath.row) 
    {
        case 0:
        {
            ...
            wallGraph=[[NegativeWallGraph alloc]initWithFrame:CGRectMake(50, 20, myTableView.frame.size.width-70, myTableView.frame.size.width * 0.5)];
...
-(NSArray *)valuesForGraph:(id)graph
{
    ...
    if([(NegativeWallGraph *)graph tag]>=10 && [(NegativeWallGraph *)graph tag]<=12)
    {
    ...
    else if([(NegativeWallGraph *)graph tag] == 13)
...
{
    if([(NegativeWallGraph *)graph tag]>=10 && [(NegativeWallGraph *)graph tag]<=16)
    {
        return YES;
    }
...
{
    if([(NegativeWallGraph *)graph tag]==11)
    {
        return YES;
    }
