...
@implementation DetailViewStyle2
...
{
    return @"Detail View Style 2 For Pie Charts (Tap on Pie to view pop Up)";
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) 
    {
        case 0:
        {
            ...
            myPieChart.detailPopUpType=mPIE_DETAIL_POPUP_TYPE2;
            [myPieChart drawPieChart];
            [cell.contentView addSubview:myPieChart];
            [cell.contentView addSubview:[self createLabelWithText:@"Basic Pie Chart Touch Enabled+ Default Alignment of Detail POp up Style2"]];
        ...
        case 1:
        {
            ...
            [myPieChart drawPieChart];
            [cell.contentView addSubview:myPieChart];
            [cell.contentView addSubview:[self createLabelWithText:@"Basic Pie Chart Touch Enabled+ Right Alignment of Detail POp up Style2"]];
        ...
        case 2:
        {
            ...
            [myPieChart drawPieChart];
            [cell.contentView addSubview:myPieChart];
            [cell.contentView addSubview:[self createLabelWithText:@"Basic Pie Chart Touch Enabled+ Bottom Alignment of Detail POp up Style2"]];
        ...
        case 3:
        {
            ...
            [myPieChart drawPieChart];
            [cell.contentView addSubview:myPieChart];
            [cell.contentView addSubview:[self createLabelWithText:@"Basic Pie Chart Touch Enabled+ Top Alignment of Detail POp up Style2"]];
